 ...
 * 2021-02-17T20:54:15.466+05:30
 * Generated source version: 3.4.2
 *
 */
@WebServiceClient(name = "AccountsPortService",
                  wsdlLocation = "file:/D:/proj_me/SSE_TASK/bank.rest.service/src/main/resources/wsdl/corebank.wsdl",
...
public class AccountsPortService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/proj_me/SSE_TASK/bank.rest.service/src/main/resources/wsdl/corebank.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AccountsPortService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/proj_me/SSE_TASK/bank.rest.service/src/main/resources/wsdl/corebank.wsdl");
        }
        WSDL_LOCATION = url;
    }
